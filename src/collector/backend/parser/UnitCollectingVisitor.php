...
use PhpParserSG\Node\Expr\Array_;
use PhpParserSG\Node\Expr\BinaryOp;
use PhpParserSG\Node\Expr\ClassConstFetch;
use PhpParserSG\Node\Expr\ConstFetch;
use PhpParserSG\Node\Expr\UnaryMinus;
use PhpParserSG\Node\Expr\UnaryPlus;
use PhpParserSG\Node\Name\FullyQualified;
use PhpParserSG\Node\NullableType;
use PhpParserSG\Node\Scalar\DNumber;
...
use PhpParserSG\Node\UnionType;
